...
const Navbar = () => {
  const openMenu = () => {
    ...
    console.info(close_button.classList);
  };
  return (
    <header className="z-10 fixed w-screen bg-white border-b-2 top-0 text-gray-600">
      <nav className="flex lg:max-w-6xl container mx-auto lg:px-8 lg:h-20 h-16 px-4 justify-between items-center">
        <a href="/">
          <Brand className="text-lg md:text-xl select-none flex items-center font-brand rounded-xl bg-slate-300 text-slate-200" />
        </a>
